...
source('/proj/c.zihao/work1/1NT/function/SSPfunction.R')
...
save_path <- paste0("/proj/c.zihao/work1/1NT/", researchAim, '/', diease_name, "/SSP")
...
resultDF <- SSPcal(exprSetFile, NomrlaFile, ppiFile, organ_name)
print(save_path)
setwd(save_path)

write.csv(resultDF, "EPm_matrix.csv")
